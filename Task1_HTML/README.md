...
- File HTML được cấu tạo bởi các tag (thẻ), các thẻ có cấu tạo `<elementname>` và thường sẽ đi theo cặp bao gồm thẻ mở và thẻ đóng, ví dụ `<p></p>`. Đôi khi một số tag đặc biệt sẽ không có thẻ đóng ví dụ như `<br>`  
